          ...
          >
            <div className="p-8 rounded-2xl bg-gradient-to-br from-neutral-800/50 to-black border border-neutral-800 hover:border-primary-500/30 transition-colors shadow-lg">
              <p className="text-lg md:text-xl text-neutral-300 leading-relaxed mb-6">
                I'm Joshua, a graphic designer in Nigeria with 2+ years of
                experience. I specialize in creating{" "}
                <span className="text-primary-400 font-medium">
                  functional designs
                </span>{" "}
                that will help communicate a brand's service or product to its
                target audience.
              </p>
              <p className="text-lg md:text-xl text-neutral-300 leading-relaxed">
                Having a keen eye for aesthetics, I make sure that every design
                I create is not only visually pleasing but also serves a clear
                strategic purpose.
              </p>
            </div>
          </motion.div>
