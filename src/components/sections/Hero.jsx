            ...
            <div className="container mx-auto px-6 relative z-10 flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight text-white">
                        I&apos;m <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-white inline-block pb-2">Joshua Udom</span>
                    </h1>
                    ...
                    <p className="text-lg text-neutral-400 mb-8 leading-relaxed">
                        I help brands to <span className="text-white font-medium hover:bg-primary-500/20 px-1 rounded transition-colors cursor-default">visually communicate</span> products and services with
                        <span className="text-white font-medium hover:bg-primary-500/20 px-1 rounded transition-colors cursor-default"> functional</span> designs to help reach their <span className="text-white font-medium hover:bg-primary-500/20 px-1 rounded transition-colors cursor-default">target audience.</span>
                    </p>
                ...
                >
                    ...
                    <div className="p-1 rounded-full bg-gradient-to-tr from-primary-500/50 to-transparent">
                        <LazyLoadImage
                            ...
                            effect="opacity"
                            alt="Joshua Udom"
                            className="bg-neutral-900 rounded-full w-64 h-64 md:w-80 md:h-80 object-cover border-4 border-black relative z-10"
                        />
                    </div>
                </motion.div>
            </div>
